...
public class Player {
	...
	public String showPrizes() {
        ...
        /**
         * Displays how much money player has left and the prizes won.
         * pre: none
         * post: player's money and prizes won are displayed.
         * @return 
         */
         public String toString(){
            ...
            playerInfo = "Player has " + money.format(spendingMoney) + " left";
